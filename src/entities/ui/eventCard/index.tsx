...
function CardEvent({ name, event, opponentScore = 0, time, userScore, opponentName, userPhoto, competitionPlace }: CardEventProps) {
  ...
  switch (event) {
        ...
        <div className="card">
          <div className="left">
            ...
            <div className="text">
              ...
              <div className="card__description">check</div></div>
          </div>
          <div className="right">
    ...
    case "duel":
      return (
        <div className="card">
          <div className="left"><div className="card__avatar">
            <Avatar src={userPhoto} size="large" icon={<UserOutlined />} />
          </div>
            <div className="text">
              <div className="card__name" >{name}</div>
              <div className="card__description" >duel with {opponentName}</div>
            </div>
          </div>
          <div className="right">
            {
        ...
        <div className="card">
          ...
          <div className="right">
            <div className="card__competition-place">
              {
                competitionPlace === 1 ? <img src={gold_trophy} alt="trophy"></img> : competitionPlace === 2 ? <img src={silver_trophy} alt="trophy"></img> :
                  competitionPlace === 3 ? <img src={bronze_trophy} alt="trophy"></img> :
                    <div className="number">Place#{competitionPlace}</div>
              }
            </div>
            <div className="card__time">{time}</div>
          </div>
